...
<!--
  ...
  //       );
        ...
        $('#generateExcel').click(function() {
        	...
        	$.ajax({
				type: "POST",
				url: "<?php echo str_replace($this->config->item('url_suffix'), "", site_url('laporan/tugas/export_excel')); ?>",
				data: {function_ref_id: '<?php echo 13; ?>',
						month: month,
						year: year
					},
...
?>	
	<div class="box-list">
		<div class="form-group">
			<label class="col-xs-2">Periode Surat Perintah</label>
			<div class="col-xs-3">
...
?>
					<tr>
						...
						<td class="data-list" width="12%"><a href="<?php echo site_url($row->link1); ?>"><?php echo $tgl_awal; ?></a></td>
						...
						<td class="data-list"><?php echo ($tujuan_disposisi != '') ? $tujuan_disposisi['jabatan'] . ' ' . $tujuan_disposisi['unit_name'] : $tujuan_distribusi; ?></td>
