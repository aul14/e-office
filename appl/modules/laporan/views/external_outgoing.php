...
<!--
  ...
  //       );
        ...
        $('#generateExcel').click(function() {
        	...
        	$.ajax({
				type: "POST",
				url: "<?php echo str_replace($this->config->item('url_suffix'), "", site_url('laporan/external/export_excel')); ?>",
				data: {function_ref_id: '<?php echo 2; ?>',
						month: month,
						year: year
					},
...
?>	
	<div class="box-list">
		<div class="form-group">
			<label class="col-xs-2">Periode Surat Keluar</label>
			<div class="col-xs-3">
