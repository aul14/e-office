...
<?php 
	...
	foreach ($distribusi_tujuan as $ak => $distribusi) {		
?>
			<tr>
...
<?php 
		if($row->surat_from_ref == 'eksternal') {
			...
			echo ((isset($distribusi['nama_unitkerja'])) ? ($distribusi['jabatan'] . ', ' . $distribusi['nama_unitkerja'] . '<br>') : $distribusi['nama_unitkerja']);
		}
?>
				</td>
