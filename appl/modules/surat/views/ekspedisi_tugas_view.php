...
?>
					<tr>
						...
						<td width="100"><a href="<?php echo ($row->format_surat_id != 8) ? site_url('surat/tugas/tugas_view/' . $row->surat_id) : site_url('surat/internal/incoming/' . $row->surat_id); ?>" target="_blank"> <?php echo strtoupper($row->jenis_agenda) . ' - ' . $row->agenda_id; ?></a></td>
						<td width="120">
